...
const Movies = () => {
  ...
  const { data: genresData } = useQuery({ queryKey: ["movieGenres"], queryFn: getMovieGenres });

  const { data, isLoading } = useQuery({
    queryKey: ["discoverMovies", genre, year, rating, page],
  ...
  return (
    <div className="min-h-screen pt-20">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold px-4 md:px-8 mb-2">Películas</h1>
        <p className="text-muted-foreground px-4 md:px-8 mb-4">Explora el catálogo completo de películas</p>
